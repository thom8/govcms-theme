 ...
 *   The form state.
 */
function datagovau_bootstrap_form_system_theme_settings_alter(&$form, &$form_state)
{
  ...
  $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_display', 'datagovau_bootstrap'),
  );
  ...
  $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
    ...
    '#default_value' => theme_get_setting('scrolltop_display', 'bdatagovau_bootstrap'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_respond', 'datagovau_bootstrap'),
  ...
  $form['mtt_settings']['tabs']['carousel']['num_carousel_items'] = array(
    ...
    '#default_value' => (int) theme_get_setting('num_carousel_items', 'datagovau_bootstrap'),
  );
